...
/**
 * Aufgabe 1: Login-Formular
 * Erstelle ein Login-Formular mit den folgenden Feldern:
 *   - Benutzername
 *   - Passwort
 */
...
/**
 * Aufgabe 2: Login
 *   - Überprüfe, ob das Formular abgesendet wurde [if ($_SERVER['REQUEST_METHOD'] == 'POST') && isset($_POST["login"])]
 ...
 *   - Leite den Benutzer weiter (z.B index.php)
 */
                            ...
                            <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                <div class="card-body p-4 p-lg-5 text-black">
                                    <form method="POST" class="needs-validation g-3" novalidate>
                                        ...
                                        <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;"> <span class="placeholder placeholder-xs col-<?= rand(3, 5); ?>"></span>
                                        </h5>
